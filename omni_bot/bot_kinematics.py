...
if __name__ == "__main__":
    ...
    # Test movements
    print("Left")
    bot.move(Vx=0.25, Vy=0.0, omega=0.0, duration=2)     # Move left for 2 second
    print("Forward")
    bot.move(Vx=0.0, Vy=0.25, omega=0.0, duration=2)     # Move forward for 2 second
    print("Right")
    bot.move(Vx=-0.25, Vy=0.0, omega=0.0, duration=2)    # Move right for 2 second
    print("Back")
    bot.move(Vx=0.0, Vy=-0.25, omega=0.0, duration=2)    # Move forward for 2 second
    print("Rotate Left")
    bot.move(Vx=0.0, Vy=0.0, omega=2, duration=3)
    print("Rotate Right")
    bot.move(Vx=0.0, Vy=0.0, omega=-2, duration=3)
